...
Если говорить по-человечески, это единая точка входа для внутренней коммуникации и рабочих материалов. Здесь можно быстро найти коллегу, написать сообщение, разослать документ, назначить обучение, провести тестирование и держать организационную структуру в актуальном виде.
